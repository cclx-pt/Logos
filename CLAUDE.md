...
## 🏗️ Arquitetura
- **Framework:** Next.js 16 + TypeScript (App Router) — _default do scaffold mantido sob tripwire (ver `status.md` ⚠️ Riscos); evitar APIs novas exclusivas de 16 sem necessidade clara._
