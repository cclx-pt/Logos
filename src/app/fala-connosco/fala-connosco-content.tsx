...
export function FalaConnoscoContent() {
  ...
  return (
    ...
    >
      ...
      >
        Queres falar Connosco ou descobrir melhor o que fazemos na CCLX &mdash; Comunidade Cristã de
        ...
        website, onde encontrarás mais informações sobre a Comunidade Cristã de Lisboa, os nossos
        projetos e outros contactos úteis.
      </motion.p>
