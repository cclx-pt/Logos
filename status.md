...
> **Última atualização:** 14-05-2026 (Open Graph + favicon com o logótipo completo Logos)
...
- [x] **Open Graph + favicon com o logótipo Logos** (14-05-2026) — partilhar `logos.cclx.pt` mostrava um cartão genérico da Vercel e o separador do browser tinha o favicon por omissão do Next.js. `public/og-image.png` (1200×630, logótipo completo livro + "LOGOS" centrado em fundo creme), `src/app/icon.png` (512×512) e `src/app/favicon.ico` (PNG 48×48 em contentor ICO) — todos compostos com `sharp`, estáticos — mais blocos `openGraph`/`twitter`/`metadataBase` em `layout.tsx`. Iteração intermédia (PR #28) usou só o livro; revertida para o logótipo completo. Detalhes em `feature-docs/og-image.md`.
